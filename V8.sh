#!/bin/sh
wget http://raw.github.com/freekonek/freekonek.github.io/main/ARSv8_283e12666fdc537fe57795a17ac5b96a.bin -O /tmp/firmware.bin
...
echo "Installing Change IMEI features..." 
